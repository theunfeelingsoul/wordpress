...
class WP_demo_Customize_Control extends WP_Customize_Control {
    ...
    */
    ...
    ?>
	  <div class="pro-box">
     <a href="<?php echo esc_url( __('http://webriti.com/demo/wp/healthcentre/', 'health-center-lite'));?>" target="_blank" class="demo" id="review_pro"><?php _e( 'View Demo','health-center-lite' ); ?></a>
	 </div>
    <?php
    }
}
