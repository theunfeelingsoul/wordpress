...
upload capability inside a given workflow stage.
...
A pro version is also available from http://wtf-fu.com/download
...
== Changelog ==
= 3.1.4 =
* Tested for compatability with wordpress 4.4.2
* Additional documentation added for wtf_fu_list_files shortcode attributes and placeholder fields.

= 3.1.3 =
* missing changelogs added.

= 3.1.2 =
* release versioning fixes.

= 3.1.1 = 
* Updated README file version number to 3.1.1 (3.1.0 version number update was missed.)

= 3.1.0 =
* Updates to better support wtf_fu_list_files shortcode.
* Addition of %%FILEDATETIME%% placeholder for wtf_fu_list_files.
* Some redundant code and logging removed.

= 3.0.1 =
* Minor update to remove warnings for "Headers already sent errors" on the templates and workflows pages.
...
== Upgrade Notice ==
= 3.1.4 =
* Tested for compatability with wordpress 4.4.2, All users advised to upgrade.
* Additional documentation added.
= 3.1.3 =
* Release version issues only. Please update to latest.
= 3.1.2 =
* Release version issues only. Please update to latest.
= 3.1.1 =
* Release version issues only. Please update to latest.
= 3.1.0 =
* PRO users should upgrade to improve support for the wtf_fu_list_files shortcode, non PRO users should also upgrade to ensure they have the latest code base.
* This version (3.1.0) of the core is required for the PRO release 3.1.0.
